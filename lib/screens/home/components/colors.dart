...
class AppColor {
  ...
  static Color gradientFirst = Color.fromARGB(255, 255, 255, 255);
  static Color gradientSecond = Color.fromARGB(255, 250, 250, 250);
  ...
  static Color secondPageTitleColor = Color.fromARGB(255, 0, 0, 0);
  ...
  static Color secondPageIconColor = Color.fromARGB(255, 0, 0, 0);
